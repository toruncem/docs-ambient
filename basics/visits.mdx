...
<Frame>
  ![Screenshot2026 01 02at5 37 43PM](/images/Screenshot2026-01-02at5.37.43PM.png)
</Frame>
...
- Date of birth
- Appointment time
- Scribe status (e.g., Generated, Incomplete)
...
> Manually added visits are only visible within Commure Ambient and do not sync to external EMRs unless custom integration is configured.
...
- Generated visits are marked with a ✅.
