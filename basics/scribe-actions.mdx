...
2. **Edit the Note**\
   ...
   - **Auto-focus**: Tap directly on any text content to enter edit mode at the exact tap location.
   - **Auto-save**: Automatically saves changes when tapping outside fields and handles nested template fields with tap-to-edit functionality.
