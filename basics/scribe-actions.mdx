...
<Frame>
  ![Screenshot2026 01 02at5 34 12PM](/images/Screenshot2026-01-02at5.34.12PM.png)
</Frame>

1. **Copy the Note**\
   Use the "Copy All" button to copy the entire note to your clipboard. You can then paste it into your EHR or any other documentation system.
2. **Edit the Note**\
...
4. **Regenerate the Note**\
   If the note does not meet your expectations, you can use the "AI Actions → Regenerate" option to create a new version, optionally providing feedback to guide improvements.
5. **Transfer to EHR**\
...
7. The Scribe will now be regenerated with newly added [Custom Formatting](https://docs.ambient.commure.com/ai_studio/custom-formatting#custom-formatting) rules or an updated template structure. 
