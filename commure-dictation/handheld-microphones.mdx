...
| Device | Model | USB VID | Status |
|--------|-------|---------|--------|
| **Nuance PowerMic III** | All variants | 0x0554 | ✅ Fully supported |
| **Nuance PowerMic IV** | All variants | TBD | 🔄 Planned |
| **Philips SpeechMike Premium** | PID 0x149A | 0x0911 | ✅ Fully supported |
| **Philips SpeechMike III** | PIDs 0x1496, 0x0C1C | 0x0911 | ✅ Fully supported |
...
| **Command** (top) | Back side, top button | Contextual Edit | Press to enter contextual editing mode using the AI |

<Tip>
The SpeechMike has two Record buttons — both work identically. On the back of the device, the **top button** is your contextual edit trigger.
</Tip>
...
- **SpeechMike**: Command button (back of the device, top button)
...
- **SpeechMike**: Command button (back of the device, bottom button)
...
| **Command** (back, top) | Revise or reformat existing text by voice |
| **Command** (back, bottom) | Undo the last contextual edit |
...
- **Undo is supported.** One-press rollback for contextual edits on both PowerMic III and SpeechMike — or use `Ctrl+Shift+Z`.
