...
2. Select the template section the macro will be added to and select "Add Macro"
   - If the same macro is required in multiple sections, it must be added individually to each section.
     ...
     <Note>
       Currently macros can only be created for the Physical Exam and Review of Systems secions and each section can have a maximum of 10 macros. Beta testing is underway to apply macros to all note sections and to increase the quanity of macros per each section.
     </Note>
3. Create your macro
   - Enter the Exam Name and Macro Content (including age range and patient genger are optional)
4. Save your newly created macros by slectong the black "Save" button at the bottom of your macro window
