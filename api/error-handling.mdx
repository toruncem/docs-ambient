...
description: "Learn how to handle errors and exceptions in the Ambient AI API"
---

## Overview

The Ambient AI API uses standard HTTP status codes to indicate success or failure. All error responses include a JSON body with error details to help you understand and resolve issues.
