...
```json 400 Bad Request
{
  "error": {
    ...
    "details": {
      "audio_file": "File is required",
      "template_ids": "At least one template ID is required"
    }
  }
}
```
...
```json 422 Unprocessable Entity
{
  "error": {
    ...
    "details": {
      "audio_file": "Invalid file format. Supported formats: mp3, wav, m4a",
      "template_ids": "Template ID 9999 does not exist"
    }
  }
}
```
...
```json 404 Not Found
{
  "error": {
    ...
    "details": {
      "resource": "scribe",
      "id": "12345",
      "reason": "Scribe ID does not exist or you don't have access"
    }
  }
}
```
...
```json 409 Conflict
{
  "error": {
    ...
    "details": {
      "resource": "scribe",
      "reason": "A scribe with this ID already exists"
    }
  }
}
```
...
Response headers also include rate limit information:

```
X-RateLimit-Limit: 100
X-RateLimit-Remaining: 0
X-RateLimit-Reset: 1736941800
```
