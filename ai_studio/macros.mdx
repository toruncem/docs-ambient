...
5. During the visit, explicitly mention the _exam_ name (**verbalize macro names**) to trigger the macro. The macro will then appear in the generated scribe and you can toggle the highlight feature on to see the dynamic values that were added within it.
