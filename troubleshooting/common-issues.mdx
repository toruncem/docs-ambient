...
<AccordionGroup>
  <Accordion title="Audio Issues" icon="sparkles">
    1. If you have started a recording and don't see the volume merer line moving, then check to see that the microphone on your device has been enabled through the accessibility settings on your device.
